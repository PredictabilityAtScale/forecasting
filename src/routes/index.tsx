  ...
  return (
    <main className="mx-auto max-w-7xl px-4 pb-16 pt-10 sm:px-6 lg:px-8">
      ...
      <section className="island-shell mt-10 overflow-hidden rounded-3xl px-6 py-8 sm:px-8 sm:py-10 lg:px-10">
        <div className="mb-6 flex flex-col gap-2 sm:mb-8">
          ...
          <p className="m-0 max-w-3xl text-sm leading-relaxed text-[var(--sea-ink-soft)] sm:text-base">
            A curated set of AI and product-focused projects designed to help
            teams learn faster, build confidently, and deliver smarter customer
            outcomes.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <p className="m-0 max-w-xl text-sm leading-relaxed text-[var(--sea-ink-soft)]">
              Practical forecasting insights, new tools, and workshop
              announcements once per month.
            </p>
          </div>
          <NewsletterSignup />
        </div>
        ...
        <div className="grid gap-8 lg:grid-cols-[320px_minmax(0,1fr)] lg:items-center">
          ...
          <div>
            ...
            <h2 className="display-title mb-4 max-w-3xl text-3xl leading-tight font-semibold tracking-tight text-[var(--sea-ink)] sm:text-4xl">
              Quantitative forecasting for software leaders who need better
              decisions, not better guesses.
            </h2>
            <div className="grid gap-3 text-sm text-[var(--sea-ink-soft)] sm:grid-cols-3">
              <div className="rounded-2xl border border-[var(--line)] bg-[var(--surface)] px-4 py-3">
                ...
                <p className="mt-1 m-0">
                  Across engineering, leadership, and delivery at scale.
                </p>
              </div>
              <div className="rounded-2xl border border-[var(--line)] bg-[var(--surface)] px-4 py-3">
                <p className="text-2xl font-semibold text-[var(--sea-ink)]">
                ...
                <p className="mt-1 m-0">
                  Focused Objective, specializing in metrics and probabilistic
                  forecasting.
                </p>
              </div>
              <div className="rounded-2xl border border-[var(--line)] bg-[var(--surface)] px-4 py-3">
                ...
                <p className="mt-1 m-0">
                  Helping teams replace opinion-driven planning with
            ...
            <div className="mt-6 space-y-4 text-sm leading-7 text-[var(--sea-ink-soft)] sm:text-base">
              <p className="m-0">
                Troy Magennis is the founder of Focused Objective and one of the
                most recognized voices in quantitative agile forecasting. He
                helps software organizations make better delivery, planning, and
                investment decisions by using historical data, flow metrics, and
                probabilistic thinking in place of intuition-heavy forecasting.
              </p>
              <p className="m-0">
                His career spans more than three decades, from hands-on
                technical roles to executive leadership in large technology
                organizations. That range matters: Troy understands both the
                mechanics of delivery and the commercial pressure behind
                portfolio choices, deadlines, dependencies, and risk.
              </p>
              <p className="m-0">
                Through consulting, training, and conference speaking, he has
                helped leaders and teams build more predictable systems of work,
                cut through misleading metrics, and create practical forecasting
                approaches that executives can actually trust. His work is
                grounded, mathematically rigorous, and relentlessly focused on
                better outcomes.
              </p>
            </div>
            ...
            <div className="mt-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:flex-wrap">
              ...
              <p className="m-0 text-sm text-[var(--sea-ink-soft)]">
                Available for workshops, advisory work, and practical
                forecasting training.
              </p>
              <a
                href="mailto:troy.magennis@focusedobjective.com"
                className="text-sm text-[var(--lagoon-deep)] underline-offset-2 transition hover:underline"
              >
      ...
      <section className="mt-10">
        <h2 className="mb-4 text-2xl font-semibold text-[var(--sea-ink)] sm:text-3xl">
          Tools
        </h2>
        <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
          <ToolCard
            ...
            icon={
              <svg
                className="h-7 w-7 text-[var(--lagoon)]"
                viewBox="0 0 24 24"
                fill="none"
                stroke="currentColor"
                strokeWidth="1.5"
          ...
          <ToolCard
            title="Voting Scorer"
            description="Enter ranked ballots and compare plurality, Borda count, and Schulze outcomes with live pairwise matrices and validation."
            href="/voting"
            delay={315}
            icon={
              <svg
      ...
      <section className="island-shell mt-10 rounded-2xl p-6 sm:p-8">
        ...
        <div className="grid gap-6 sm:grid-cols-3">
          <div>
            ...
            <p className="m-0 text-sm leading-relaxed text-[var(--sea-ink-soft)]">
              Use actual throughput data instead of story point estimates. Let
              the math do the heavy lifting.
            </p>
          </div>
          <div>
            <h3 className="mb-2 text-base font-semibold text-[var(--sea-ink)]">
          ...
          <div>
            ...
            <p className="m-0 text-sm leading-relaxed text-[var(--sea-ink-soft)]">
              All simulations run client-side. Your data never leaves your
              machine.
            </p>
          </div>
        </div>
